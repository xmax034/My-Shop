...
const db = (() => {
    ...
    const sliders = [
        {
            name: 'slide-1',
            image: 'https://cdn.anh.moe/c/rfTmk.png?wp=1',
            path: '#'
        },
        {
            name: 'slide-2',
            image: 'https://cdn.anhmoe.sbs/c/ssFXh.webp?wp=1',
            path: '#'

        },
        {        
            name: 'slide-3',
            image: 'https://cdn.anh.moe/c/rfUqh.png?wp=1',
            path: '#'
        }
    ]    
    const banners = [
        {
            name: 'Side Banner-1',
            image: 'https://cdn.anh.moe/c/rfEis.png?wp=1',
            type: 'small',
            path: '#'            
        },
        {
            name: 'Side Banner-2',
            image: 'https://cdn.anh.moe/c/rfipO.png?wp=1',
            type: 'small',
            path: '#'            
        },
        {
            name: 'Content Banner-1',
            image: 'https://cdn.anhmoe.sbs/c/seNTJ.webp?wp=1',
            type: 'larg-1',            
            path: '#'
        },
        {            
            name: 'Content Banner-2',
            image: 'https://cdn.anh.moe/c/qEySx.png?wp=1',            
            type: 'larg-2',            
            path: '#'
        }
    ];  
    ...
    const phones = [
        {
            ...
            image: 'https://cdn.anhmoe.sbs/c/suCvD.webp?wp=1',
            brand: 'Apple',
        ...
        },
        {
            ...
            image: 'https://cdn.anhmoe.sbs/c/se8aA.webp?wp=1',
            brand: 'Samsung',
        ...
        },
        {
            ...
            image: 'https://cdn.anhmoe.sbs/c/seele.webp?wp=1',
            brand: 'Oppo',
        ...
        },
        {
            ...
            image: 'https://cdn.anhmoe.sbs/c/seRmp.webp?wp=1',
            brand: 'Xiaomi',
        ...
        },
        {
            ...
            image: 'https://cdn.anhmoe.sbs/c/seHMx.webp?wp=1',
            brand: 'Honor',
    ...
    const laptops = [
        {
            ...
            image: 'https://cdn.anhmoe.sbs/c/se5jW.webp?wp=1',
            brand: 'Apple',
        ...
        },
        {
            ...
            image: 'https://cdn.anhmoe.sbs/c/sqjTh.webp?wp=1',
            brand: 'Asus',
        ...
        },
        {
            ...
            image: 'https://cdn.anhmoe.sbs/c/sq0lX.webp?wp=1',
            brand: 'Lenovo',
        ...
        },
        {
            ...
            image: 'https://cdn.anhmoe.sbs/c/sr4m6.webp?wp=1',
            brand: 'Acer',
            curPrice: '12.990.000 đ',
        ...
        },
        {
            ...
            image: 'https://cdn.anhmoe.sbs/c/sr7qd.webp?wp=1',
            brand: 'Acer',
            curPrice: '17.990.000 đ',
